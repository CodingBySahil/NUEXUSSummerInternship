...
const BestSeller = () => {
  const bestSellerProducts = [
    ...
    {
      src: "/assets/images/bestSeller4.jpeg",
      title: "Fried Rice of the day",
      price: "$9.99"
    },
    {
      src: "/assets/images/bestSeller5.jpeg",
      title: "Chicken of the day",
      price: "$13.99"
    },
    {
      src: "/assets/images/bestSeller6.jpeg",
      title: "Burger of the day",
      price: "$12.99"
    },
    {
      src: "/assets/images/bestSeller7.jpeg",
      title: "Pizza of the day",
      price: "$15.99"
    },
    {
      src: "/assets/images/bestSeller8.jpeg",
      title: "Sandwich of the day",
      price: "$10.99"
    },
  ];
        ...
        {bestSellerProducts.map((product, index) => (
          <div key={index} className="flex flex-col justify-center items-start p-2 bg-white dark:bg-gray-900">
            <div className="relative">
              <img
                className="w-full h-64 object-cover" // Added consistent width and height
                src={product.src}
                alt={product.title}
              />
